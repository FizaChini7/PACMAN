...
void move_figures()
{
   ...
   myPacMan.position.x = myPacMan.position.x+myPacMan.vx;
   myPacMan.position.y = myPacMan.position.y+myPacMan.vy;
...
int main(){
  ...
  printf("\t\t    ---:|| ######   #########     #          #   #   #    #########    #   #   # || :---\n");
   ...
   system("cls");//This library function is used to run system/ command prompt commands and here cls is a command to clear the output screen.
